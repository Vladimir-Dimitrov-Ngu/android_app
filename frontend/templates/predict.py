...
PREDICT_FRONT = dbc.Container(
    fluid=True,
    children=[
        html.H1("Предсказания", className="display-10", style={"textAlign": "center","minHeight": "70px", "marginBottom": 20, "marginTop" : 20}),
        ...
        html.H2("Добавить файл", id='upload', style={"marginBottom": 20,  "marginTop" : 40}),
        dcc.Upload(
            id="upload-data",
            children=html.Div(
