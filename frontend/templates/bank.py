...
BANK_FRONT = html.Div([
    ...
    html.P('Здесь вы можете пополнить свой счет', style={'font-size':20, 'marginBottom': 30}),
    dbc.Row(
            [
                        dbc.Col(
                            dbc.Button(
                        ...
                        dbc.Col(html.H3(id="counter_bank", children=0), width="auto", style={'marginTop': 10, 'marginLeft': 25}),
                    ],
                    className="mt-4",),
    dbc.Row([dbc.Col(html.Img(src="/assets/payment.png", height="150px", style={'position': 'absolute', 'bottom': '0', 'marginLeft': 350}), width=4)]),
    dcc.Interval(
