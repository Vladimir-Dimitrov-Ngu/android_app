...
from frontend.callback import (
    ...
    bank_button_main_page,
    flash_predict_button,
    test,
    get_predict,
    render_page_content,
    update_counter_balance,
    update_model,
    update_predict_callback,
...
app_dash.callback(*ARGUMENTS_FOR_CHANGE_COLOR_BUTTON, prevent_initial_call=True)(
    flash_predict_button
)
